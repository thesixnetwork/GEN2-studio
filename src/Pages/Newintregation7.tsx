            ...
            <div className='w-full h-full fixed  flex justify-center items-center bg-gradient-24  from-white to-[#7A8ED7]'>
                <div className='w-[1280px] h-[832px] bg-gradient-24 to-gray-700 from-gray-300 rounded-2xl flex justify-between p-4 shadow-lg shadow-black/20 dark:shadow-black/40'>
                    <div className='w-full h-full px-[20px]'>
                        ...
                        <div className='mt-7 ml-10 w-full  grid-cols-3 grid justify-center items-center '>
                            <div className='w-[227px] h-[157px] bg-transparent border border-white rounded-xl p-3 '>
                                <div className='w-[24px] h-[24px]  flex justify-center items-center rounded-full absolute ml-[185px] mt-[-7px]'>
                                    <img src={Delete}></img>
                                </div>
                            ...
                            <div className='w-[227px] h-[157px] flex justify-center items-center bg-transparent border border-white rounded-xl p-3 hover:scale-105 cursor-pointer duration-300 '>
                                <img src={Add}></img>

                            </div>     
                        </div>
                        <NextPageButton TextTitle='Next' BorderRadius={0} NextPage='/newintregation/8' FontSize={40}  ></NextPageButton>
                    </div>
