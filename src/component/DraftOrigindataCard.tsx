...
import { IisSchemaInfo } from "../types/Nftmngr";
...
function DraftOrigindataCard(Props: ComponentProps) {
  ...
  const [isInputDisabledOriginChain, setisInputDisabledOriginChain] =
    useState(true);
  const [isInputDisabledCollectionData, setisInputDisabledCollectionData] =
    useState(true);
  const [schemaInfo, setschemaInfo] = useState<IisSchemaInfo | null>(null);
  const [FirstschemaInfo, setFirstschemaInfo] = useState<IisSchemaInfo | null>(null);
  ...
  const findSchemaCode = async () => {
    ...
    await axios
      ...
      .then((response) => {
        console.log(
          "SchemaInFo FindSchemaCode :",
          response.data.data.schema_info
        );
  ...
  const handleChangeValue = (
    ...
    setschemaInfo((prevState) => {
      ...
      if (stateVariable === "schema_info.origin_data.origin_base_uri") {
        ...
        stateVariable === "schema_info.origin_data.origin_contract_address"
      ) {
        newState.schema_info.origin_data.origin_contract_address =
          e.target.value;
  ...
  return (
    <div className=" w-full flex flex-col justify-center items-center">
      <div className=" mt-10 w-[90%] border border-white rounded-xl p-5 relative">
        <div
          onClick={() =>
            setisInputDisabledCollectionData(!isInputDisabledCollectionData)
          }
          ...
          <div className=" m-5 flex flex-col">
            ...
            <div className=" flex  justify-start items-end mt-5">
              ...
              <input
                ...
                className={` w-[30%] bg-transparent text-[14px] border-[1px] ${
                  isInputDisabledCollectionData
                    ? "border-none"
                    : "border-[#D9D9D9DD]"
                } placeholder-gray-300 border-dashed p-1 focus:outline-none focus:scale-105  w-[140px]`}
              ></input>
            </div>
            <div className=" flex  justify-start items-end mt-5">
              ...
              <input
                ...
                className={`w-[50%] bg-transparent text-[14px] border-[1px] ${
                  isInputDisabledCollectionData
                    ? "border-none"
                    : "border-[#D9D9D9DD]"
                } placeholder-gray-300 border-dashed p-1 focus:outline-none focus:scale-105  w-[140px]`}
      ...
      <div className=" mt-10 w-[90%] border border-white rounded-xl p-5 relative">
        <div
          onClick={() =>
            setisInputDisabledOriginChain(!isInputDisabledOriginChain)
          }
          className=" flex justify-center items-center absolute right-2 top-2 border-white border rounded-full w-10 h-10 hover:scale-105 duration-500 cursor-pointer "
        >
          <EditIcon></EditIcon>
          ...
          <div className=" m-5">
            <div className=" flex  justify-start items-center">
              ...
              <FormControl sx={{ m: 1, minWidth: 120 }}>
                <InputLabel className="" htmlFor="grouped-native-select">
                  NETWORK
                </InputLabel>
                <Select
            ...
            <div className=" flex  justify-start items-end mt-5">
              ...
              <input
                value={
                  schemaInfo.schema_info.origin_data.origin_contract_address
                }
                type="text"
                ...
                onChange={(e) => {
                  handleChangeValue(
                    e,
                    "schema_info.origin_data.origin_contract_address"
                  );
                }}
                className={` w-[50%] bg-transparent text-[14px] border-[1px] ${
                  isInputDisabledOriginChain
                    ? "border-none"
                    : "border-[#D9D9D9DD]"
                } placeholder-gray-300 border-dashed p-1 focus:outline-none focus:scale-105 w-[140px]`}
              ></input>
            ...
            <div className=" flex  justify-start items-end mt-5">
              ...
              <input
                ...
                onChange={(e) => {
                  handleChangeValue(
                    e,
                    "schema_info.origin_data.origin_base_uri"
                  );
                }}
                className={` w-[70%] bg-transparent text-[14px] border-[1px] ${
                  isInputDisabledOriginChain
                    ? "border-none"
                    : "border-[#D9D9D9DD]"
                } placeholder-gray-300 border-dashed p-1 focus:outline-none focus:scale-105 w-[140px]`}
